...
System.register(["./card-view-model"], function (_export, _context) {
    "use strict";

    var CardViewModel, _createClass, CardViewPort;
    ...
    return {
        setters: [function (_cardViewModel) {
            CardViewModel = _cardViewModel.CardViewModel;
        }],
        execute: function () {
            ...
            _export("CardViewPort", CardViewPort = function (_CardViewModel) {
            ...
            _export("CardViewPort", CardViewPort);
        }
    };
});
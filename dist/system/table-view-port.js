...
System.register(["./table-view-model"], function (_export, _context) {
    "use strict";

    var TableViewModel, _createClass, TableViewPort;
    ...
    return {
        setters: [function (_tableViewModel) {
            TableViewModel = _tableViewModel.TableViewModel;
        }],
        execute: function () {
            ...
            _export("TableViewPort", TableViewPort = function (_TableViewModel) {
            ...
            _export("TableViewPort", TableViewPort);
        }
    };
});